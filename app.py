...
# --- Streamlit UI ---
st.set_page_config(page_title="Monthly Projection Tool", page_icon="📅")
st.title("📅Month-by-Month Outlook")
...
if st.button("Run Monthly Forecast"):
    with st.spinner("🔄 Forecast is being calculated... Please wait"):
